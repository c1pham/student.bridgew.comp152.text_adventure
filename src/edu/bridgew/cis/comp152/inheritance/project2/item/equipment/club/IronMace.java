...
public class IronMace extends Club {
	public IronMace(float level) {
		super("Iron Mace", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.IRON_MACE.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.IRON_MACE.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.IRON_MACE.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.IRON_MACE.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
