...
public class RobotArm extends Club {
	public RobotArm(float level) {
		super("Robot Arm", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.ROBOT_ARM.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ROBOT_ARM.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ROBOT_ARM.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.ROBOT_ARM.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"Lighting");
		this.level = level;
		createItemID();
	}
