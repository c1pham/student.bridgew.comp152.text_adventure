...
public class BigTuna extends Club {
	public BigTuna(float level) {
		super("Big Tuna", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.BIG_TUNA.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.BIG_TUNA.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.BIG_TUNA.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.BIG_TUNA.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"Ice");
		this.level = level;
		createItemID();
	}
