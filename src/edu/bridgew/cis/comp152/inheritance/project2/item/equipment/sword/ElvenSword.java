...
public class ElvenSword extends Sword {

	public ElvenSword(float level) {
		super("Elven Sword", 600f + (level * 5), 45f + (level * 5), 
				Database.swordStatsVar[Database.swordType.ELVEN_SWORD.ordinal()][Database.swordStat.DAMAGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.ELVEN_SWORD.ordinal()][Database.swordStat.ATTACK_CHANGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.ELVEN_SWORD.ordinal()][Database.swordStat.CRIT_DMG_CHANGE.ordinal()],
				Database.swordStatsVar[Database.swordType.ELVEN_SWORD.ordinal()][Database.swordStat.SPEED_INCREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
