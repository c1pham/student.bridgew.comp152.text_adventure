...
public class HeroBlade extends Sword {

	public HeroBlade(float level) {
		super("Hero Blade", 600f + (level * 2), 45f + (level * 2), 
				Database.swordStatsVar[Database.swordType.HERO_BLADE.ordinal()][Database.swordStat.DAMAGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.HERO_BLADE.ordinal()][Database.swordStat.ATTACK_CHANGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.HERO_BLADE.ordinal()][Database.swordStat.CRIT_DMG_CHANGE.ordinal()],
				Database.swordStatsVar[Database.swordType.HERO_BLADE.ordinal()][Database.swordStat.SPEED_INCREASE.ordinal()],
				"Fire");
		this.level = level;
		createItemID();
	}
