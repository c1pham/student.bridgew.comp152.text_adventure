...
public class PowerBow extends Bow {
	public PowerBow(double level) {
		super("Power Bow", "Fire",
				Database.bowStatsVar[Database.bowType.POWER_BOW.ordinal()][Database.bowStats.DAMAGE.ordinal()],
				Database.bowStatsVar[Database.bowType.POWER_BOW.ordinal()][Database.bowStats.ATTACK_CHANGE.ordinal()],
				Database.bowStatsVar[Database.bowType.POWER_BOW.ordinal()][Database.bowStats.CRIT_DMG_CHANGE.ordinal()],
				Database.bowStatsVar[Database.bowType.POWER_BOW.ordinal()][Database.bowStats.CRIT_RATE_CHANGE.ordinal()]);
		createItemID();
	}
