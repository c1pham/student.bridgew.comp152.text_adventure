...
public class OldBow extends Bow {
	public OldBow(double level) {
		super("Old Bow", "None",
				Database.bowStatsVar[Database.bowType.OLD_BOW.ordinal()][Database.bowStats.DAMAGE.ordinal()],
				Database.bowStatsVar[Database.bowType.OLD_BOW.ordinal()][Database.bowStats.ATTACK_CHANGE.ordinal()],
				Database.bowStatsVar[Database.bowType.OLD_BOW.ordinal()][Database.bowStats.CRIT_DMG_CHANGE.ordinal()],
				Database.bowStatsVar[Database.bowType.OLD_BOW.ordinal()][Database.bowStats.CRIT_RATE_CHANGE.ordinal()]);
		createItemID();
	}
