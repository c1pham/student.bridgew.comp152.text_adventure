...
public class CoconutLauncher extends Gun {

	public CoconutLauncher(double level) {
		super("Coconut Launcher", "None",
				Database.gunStatsVar[Database.gunType.COCONUT_LAUNCHER.ordinal()][Database.gunStats.DAMAGE.ordinal()],
				Database.gunStatsVar[Database.gunType.COCONUT_LAUNCHER.ordinal()][Database.gunStats.ATTACK_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.COCONUT_LAUNCHER.ordinal()][Database.gunStats.CRIT_DMG_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.COCONUT_LAUNCHER.ordinal()][Database.gunStats.SCOPE_AC.ordinal()]);
