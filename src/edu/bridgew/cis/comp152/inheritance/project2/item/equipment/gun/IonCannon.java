...
public class IonCannon extends Gun {


	public IonCannon(double level) {

		super("Ion Cannon", "Energy",
				Database.gunStatsVar[Database.gunType.ION_CANNON.ordinal()][Database.gunStats.DAMAGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ION_CANNON.ordinal()][Database.gunStats.ATTACK_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ION_CANNON.ordinal()][Database.gunStats.CRIT_DMG_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ION_CANNON.ordinal()][Database.gunStats.SCOPE_AC.ordinal()]);
