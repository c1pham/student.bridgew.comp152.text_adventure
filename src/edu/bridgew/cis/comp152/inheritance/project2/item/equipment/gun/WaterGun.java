...
public class WaterGun extends Gun {
	public WaterGun(double level) {
		super("Water Gun", "Ice",
				Database.gunStatsVar[Database.gunType.WATER_GUN.ordinal()][Database.gunStats.DAMAGE.ordinal()],
				Database.gunStatsVar[Database.gunType.WATER_GUN.ordinal()][Database.gunStats.ATTACK_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.WATER_GUN.ordinal()][Database.gunStats.CRIT_DMG_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.WATER_GUN.ordinal()][Database.gunStats.SCOPE_AC.ordinal()]);
