...
public class Twig extends Sword {

	public Twig(float level) {
		super("Twig", 10f + (level * 10), 10f + (level * 2), 
				Database.swordStatsVar[Database.swordType.TWIG.ordinal()][Database.swordStat.DAMAGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.TWIG.ordinal()][Database.swordStat.ATTACK_CHANGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.TWIG.ordinal()][Database.swordStat.CRIT_DMG_CHANGE.ordinal()],
				Database.swordStatsVar[Database.swordType.TWIG.ordinal()][Database.swordStat.SPEED_INCREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
