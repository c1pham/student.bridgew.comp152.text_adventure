...
public class RobotLeg extends Club {
	public RobotLeg(float level) {
		super("Robot Leg", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.ROBOT_LEG.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ROBOT_LEG.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ROBOT_LEG.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.ROBOT_LEG.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"Lighting");
		this.level = level;
		createItemID();
	}
