...
public class SharpStick extends Sword {

	public SharpStick(float level) {
		super("Sharp Stick", 10f + (level * 10), 10f + (level * 2), 
				Database.swordStatsVar[Database.swordType.SHARP_STICK.ordinal()][Database.swordStat.DAMAGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.SHARP_STICK.ordinal()][Database.swordStat.ATTACK_CHANGE.ordinal()], 
				Database.swordStatsVar[Database.swordType.SHARP_STICK.ordinal()][Database.swordStat.CRIT_DMG_CHANGE.ordinal()],
				Database.swordStatsVar[Database.swordType.SHARP_STICK.ordinal()][Database.swordStat.SPEED_INCREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
