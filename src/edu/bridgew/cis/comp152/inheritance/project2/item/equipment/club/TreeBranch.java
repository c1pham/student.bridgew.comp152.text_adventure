...
public class TreeBranch extends Club {

	public TreeBranch(float level) {
		super("Tree Branch", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.TREE_BRANCH.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.TREE_BRANCH.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.TREE_BRANCH.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.TREE_BRANCH.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
