...
public class ElvenClub extends Club {
	
	public ElvenClub(float level) {
		super("Elven Club", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.ELVEN_CLUB.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ELVEN_CLUB.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.ELVEN_CLUB.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.ELVEN_CLUB.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
