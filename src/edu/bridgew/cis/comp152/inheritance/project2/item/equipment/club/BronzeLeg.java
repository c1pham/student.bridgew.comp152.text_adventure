...
public class BronzeLeg extends Club {

	public BronzeLeg(float level) {
		super("Bronze Leg", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.BRONZE_LEG.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.BRONZE_LEG.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.BRONZE_LEG.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.BRONZE_LEG.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"None");
		this.level = level;
		createItemID();
	}
