...
public class ElvenShotgun extends Gun {
	public ElvenShotgun(double level) {

		super("Elven Shotgun", "Fire",
				Database.gunStatsVar[Database.gunType.ELVEN_SHOTGUN.ordinal()][Database.gunStats.DAMAGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ELVEN_SHOTGUN.ordinal()][Database.gunStats.ATTACK_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ELVEN_SHOTGUN.ordinal()][Database.gunStats.CRIT_DMG_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.ELVEN_SHOTGUN.ordinal()][Database.gunStats.SCOPE_AC.ordinal()]);
