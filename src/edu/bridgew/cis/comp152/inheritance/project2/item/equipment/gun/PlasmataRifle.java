...
public class PlasmataRifle extends Gun {

	public PlasmataRifle(double level) {
		super("Plasmata Rifle", "Energy",
				Database.gunStatsVar[Database.gunType.PLASMATA_RIFLE.ordinal()][Database.gunStats.DAMAGE.ordinal()],
				Database.gunStatsVar[Database.gunType.PLASMATA_RIFLE.ordinal()][Database.gunStats.ATTACK_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.PLASMATA_RIFLE.ordinal()][Database.gunStats.CRIT_DMG_CHANGE.ordinal()],
				Database.gunStatsVar[Database.gunType.PLASMATA_RIFLE.ordinal()][Database.gunStats.SCOPE_AC.ordinal()]);
		createItemID();
	}
