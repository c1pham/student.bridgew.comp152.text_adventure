...
public class Firewood extends Club {
	public Firewood(float level) {
		super("Firewood", 10f + (level * 10), 10f + (level * 2), 
				Database.clubStatsVar[Database.clubType.FIREWOOD.ordinal()][Database.clubStat.DAMAGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.FIREWOOD.ordinal()][Database.clubStat.ATTACK_CHANGE.ordinal()], 
				Database.clubStatsVar[Database.clubType.FIREWOOD.ordinal()][Database.clubStat.CRIT_DMG_CHANGE.ordinal()],
				Database.clubStatsVar[Database.clubType.FIREWOOD.ordinal()][Database.clubStat.SPEED_DECREASE.ordinal()],
				"Fire");
		this.level = level;
		createItemID();
	}
