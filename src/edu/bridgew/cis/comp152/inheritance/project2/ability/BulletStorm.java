...
public class BulletStorm extends Ability {
	public BulletStorm() {
		super("Bullet Storm",
	...
	public boolean useAbility(Entity self, Entity target) {
		...
		atkDescript[0] = "Grenade Launchers!";
		atkDescript[1] = "Freeze Rays!";
		atkDescript[2] = "Shock Cannons!";
		atkDescript[3] = "Laser Guns!";
		...
		System.out.println(self.getName() + " uses Bullet Storm and unleashes four elemental attacks.");
		System.out.println();
